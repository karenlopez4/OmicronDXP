...
describe("Inventario MP", function (){
    ...
    it("Validar existencia de faltante 'MP-093' y 'MP-232'", function(){
        ...
        //Validaciones
        cy.wait(2000);
        cy.contains(`${this.datos.producto1Descripcion}, ${this.datos.producto2Descripcion} no disponible temporalmente`).should("exist");
    });  
});