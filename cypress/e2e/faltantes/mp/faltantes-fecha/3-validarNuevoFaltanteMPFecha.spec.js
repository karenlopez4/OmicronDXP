...
describe("Inventario MP", function (){
    ...
    it("Validar existencia de faltante 'MP-093' y 'MP-232' en catalogo con fecha asignada", function(){
        ...
        faltante.validarFaltanteMateriaPrimaFecha(this.datos.producto1Descripcion,this.datos.producto2Descripcion);
    });  
});