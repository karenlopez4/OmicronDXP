...
describe("Inventario PT", function (){
    ...
    it("Crear existencia de faltante 'REVE 2' disponible con fecha asignada", function(){
        ...
        faltante.datosFaltanteProductoTerminadoFecha(this.datos.productoTerminado);
        faltante.botonDisponible();
        faltante.botonGuardar();
        faltante.botonAceptar();
        //Validacion
        cy.contains(this.datos.productoTerminado).should("exist");
    });  
});